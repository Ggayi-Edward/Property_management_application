...
class ForgotPasswordLandlord extends StatefulWidget {
  const ForgotPasswordLandlord({super.key});

  @override
  _ForgotPasswordLandlordState createState() => _ForgotPasswordLandlordState();
}

class _ForgotPasswordLandlordState extends State<ForgotPasswordLandlord> {
